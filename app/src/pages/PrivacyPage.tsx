  ...
  return (
    <article className="mx-auto max-w-prose px-4 py-12 text-left">
      ...
      <p>
        ...
        <a href={SITE_ORIGIN}>{host}</a>. It is a plain-language notice, not legal advice.
      </p>
      <p>
        This starter is built by{' '}
        <a href={SITE_AUTHOR_URL} rel="noopener noreferrer">
          {SITE_AUTHOR_NAME}
        </a>
        . After you fork it, this notice still applies to whatever you host until you change it.
      </p>
      <h2>Product analytics (PostHog)</h2>
      <p>
        The public site uses <a href="https://posthog.com">PostHog</a> Cloud EU (via a first-party
        ingest host) so we can see which pages people open.
      </p>
      <p>
        ...
        <code>identify()</code>. Counts use a privacy-preserving hash on PostHog’s servers. Session
        replay is off on this site.
      </p>
      <p>
        That is why this site does not show a cookie banner for PostHog. Cloudflare or the browser
        may still use their own cookies for hosting or security.
      </p>
      ...
      <p>
        We do not sell your data. We do not run ads. You do not need an account to read this site.
      </p>
